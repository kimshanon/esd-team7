...
PICKER_SERVICE_URL = os.getenv("PICKER_SERVICE_URL", "http://localhost:5004")
...
def process_refund_endpoint(payment_id):
    ...
    # 3. Only process refund if order is Active or if it's a customer-requested refund for Completed order
